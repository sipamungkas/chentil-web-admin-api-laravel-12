...
import { BreadcrumbItem, District, Province, Regency } from '@/types';
...
export default function Edit({ district }: Props) {
    ...
    const [formData, setFormData] = useState({
        code: district.code,
        name: district.name,
        province_id: district.regency.province.id.toString(),
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.put(`/dashboard/districts/${district.id}`, formData, {
            onSuccess: () => {
                setProcessing(false);
            },
            onError: (errors) => {
